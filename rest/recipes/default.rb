...
directory installDirectory + projectName+ "/kubernates" do
  owner 'ravi.dhyani'
 # group 'group_name'
  mode '0755'
  recursive true
...
template installDirectory + projectName + "/kubernates"+ "/springboot-deployment.yaml" do
  source 'kubernates/springboot-deployment.yaml.erb'
 variables(
    name: 'ravi.dhyani',
...
template installDirectory + projectName + "/kubernates"+ "/springboot-ingress.yaml" do
  source 'kubernates/springboot-ingress.yaml.erb'
  variables(
    name: 'ravi.dhyani'
  )
  owner 'ravi.dhyani'
...
template installDirectory + projectName + "/kubernates"+ "/springboot-service.yaml" do
  source 'kubernates/springboot-service.yaml.erb'
  variables(
    name: 'ravi.dhyani'
  )
  owner 'ravi.dhyani'
...
template installDirectory + projectName+ "/src/main/resources/graphql-client/QueryUtils.java" do
  source 'QueryUtils.java.erb'
  variables(
    name: 'ravi.dhyani'
  )
